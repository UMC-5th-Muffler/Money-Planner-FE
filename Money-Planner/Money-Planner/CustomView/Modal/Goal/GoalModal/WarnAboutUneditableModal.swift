...
class WarnAboutUneditableModal : UIViewController {
    ...
    let durationLabel: UILabel = {
        ...
        let startDate = GoalCreationManager.shared.startDate?.toDate ?? Date.todayAtMidnight
        let endDate = GoalCreationManager.shared.endDate?.toDate ?? Date.todayAtMidnight
